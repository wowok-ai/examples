...
import { Account, call_demand_json, call_guard, call_guard_json, call_permission, call_permission_json, call_personal, call_personal_json, call_repository_json, call_service, call_service_json, call_treasury_json, CallArbitrationSchemaInput, CallGuard_Data, CallPermissionObject, CallService, CallService_Data, CallServiceObject, local_mark_operation, query_local_mark_list, query_objects, query_objects_json, query_personal, query_personal_json, WOWOK } from 'wowok_agent';

...
import { Account, call_machine, CallMachine, CallMachine_Data, CallService_Data, GetAccountOrMark_Address, GuardInfo_forCall, LocalMark } from 'wowok_agent';
...
export const run_service = async (insurance_service:ServiceReturn, traval_service:ServiceReturn) => {    
    ...
    const buy : CallService_Data = { object:traval_service.service, 
    ...
    const buy_insurance : CallService_Data = { object:insurance_service.service, 

import { Account, call_service, ResponseData, WOWOK } from 'wowok_agent';
...
export const PUBKEY = '-----BEGIN PUBLIC KEY----- \
            ...
            -----END PUBLIC KEY-----';
export const result = async (type, res, account, witness) => {
    //console.log(res)
    if (res?.digest) {
...
export const launch_order = async (data, account, witness) => {
...
export const INSURANCE_PRODUCT = { item: 'Outdoor accident insurance',
    price: '5', stock: '102', endpoint: 'https://x4o43luhbc.feishu.cn/docx/IyA4dUXx1o6ilDxQMMKc3CoonGd?from=from_copylink' };
export const TRAVEL_PRODUCT = { item: 'Traveling Iceland',
...
export var GUARDS_NAME;
(function (GUARDS_NAME) {
    GUARDS_NAME["ice_scooting"] = "ice_scooting";
    GUARDS_NAME["cancel_ice_scooting"] = "cancel_ice_scooting";
    GUARDS_NAME["complete_ice_scooting"] = "complete_ice_scooting";
})(GUARDS_NAME || (GUARDS_NAME = {}));
export const check_account = async (name) => {
